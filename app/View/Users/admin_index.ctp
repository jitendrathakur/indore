<div class="users index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('fb_access_token'); ?></th>
			...
			<th><?php echo $this->Paginator->sort('reset_password_code'); ?></th>
			<th><?php echo $this->Paginator->sort('reset_password_date'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($user['User']['fb_access_token']); ?>&nbsp;</td>
		...
		<td><?php echo h($user['User']['reset_password_code']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['reset_password_date']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['private']); ?>&nbsp;</td>
